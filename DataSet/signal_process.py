...
def deal_CSI(csi,IFfilter=True,IFphasani=True,padding_length=None,IFinterp=None,interp_length=None,new_length=None,interp1d_kind='quadratic',step_size=4):
    amp=abs(csi)
